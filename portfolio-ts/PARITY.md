...
| `portfolio migrate-duckdb-to-postgres` | — | **intentionally dropped** | The former storage engine has been removed. The Python→PostgreSQL migration was completed before the TypeScript cutover. |
