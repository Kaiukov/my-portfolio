...
import { toWriteErrorEnvelope } from "./shared.js";
...
import { strField, intField, floatField } from "../mcp/adapter.js";
 ...
 * This is the canonical read path; all adapters must delegate here.
 */
