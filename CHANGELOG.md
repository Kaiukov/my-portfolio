...
### Fixed
- **#329 / #330** — MCP write tools now advertise per-tool input schemas instead
  of an empty passthrough schema, including documented parameter aliases for
  transaction IDs, dry-run flags, fee currency, data source, and exchange source/
  target fields. Alias validation now accepts the aliases directly instead of
  requiring the primary field in addition to the alias.
- **#311 / #312** — dashboard snapshots include `version` from the shared
  `APP_VERSION` source, preserving version parity for the published dashboard
  payload.
...
[Unreleased]: https://github.com/Kaiukov/my-portfolio/compare/v0.9.2...HEAD
[0.9.2]: https://github.com/Kaiukov/my-portfolio/compare/v0.9.1...v0.9.2
[0.9.1]: https://github.com/Kaiukov/my-portfolio/compare/v0.9.0...v0.9.1
[0.9.0]: https://github.com/Kaiukov/my-portfolio/compare/v0.8.0...v0.9.0
