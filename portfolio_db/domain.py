...
SUPPORTED_FX_TICKERS = (
    'EURUSD=X', 'GBPUSD=X', 'UAHUSD=X',
    'JPYUSD=X', 'CHFUSD=X', 'CADUSD=X',
    'AUDUSD=X', 'HKDUSD=X', 'SGDUSD=X',
)
CASH_FX_SYMBOLS = (
    'EURUSD=X', 'GBPUSD=X', 'UAHUSD=X',
    'JPYUSD=X', 'CHFUSD=X', 'CADUSD=X',
...
CASH_BUCKET_DEFAULTS = {
    ...
    'JPYUSD=X': {'balance': 0.0, 'deposits': 0.0, 'transfers_in': 0.0, 'withdrawals': 0.0, 'spent': 0.0, 'received': 0.0, 'dividends': 0.0, 'interest': 0.0, 'fees': 0.0, 'taxes': 0.0},
    'CHFUSD=X': {'balance': 0.0, 'deposits': 0.0, 'transfers_in': 0.0, 'withdrawals': 0.0, 'spent': 0.0, 'received': 0.0, 'dividends': 0.0, 'interest': 0.0, 'fees': 0.0, 'taxes': 0.0},
    'CADUSD=X': {'balance': 0.0, 'deposits': 0.0, 'transfers_in': 0.0, 'withdrawals': 0.0, 'spent': 0.0, 'received': 0.0, 'dividends': 0.0, 'interest': 0.0, 'fees': 0.0, 'taxes': 0.0},
    'AUDUSD=X': {'balance': 0.0, 'deposits': 0.0, 'transfers_in': 0.0, 'withdrawals': 0.0, 'spent': 0.0, 'received': 0.0, 'dividends': 0.0, 'interest': 0.0, 'fees': 0.0, 'taxes': 0.0},
    'HKDUSD=X': {'balance': 0.0, 'deposits': 0.0, 'transfers_in': 0.0, 'withdrawals': 0.0, 'spent': 0.0, 'received': 0.0, 'dividends': 0.0, 'interest': 0.0, 'fees': 0.0, 'taxes': 0.0},
    'SGDUSD=X': {'balance': 0.0, 'deposits': 0.0, 'transfers_in': 0.0, 'withdrawals': 0.0, 'spent': 0.0, 'received': 0.0, 'dividends': 0.0, 'interest': 0.0, 'fees': 0.0, 'taxes': 0.0},
}
...
def get_asset_type(ticker: str) -> str:
    ...
    Returns:
        ...
        - 'stock_jpy': Japanese stocks (ends with .T)
        - 'stock_chf': Swiss stocks (ends with .SW)
        - 'stock_cad': Canadian stocks (ends with .TO)
        - 'stock_aud': Australian stocks (ends with .AX)
        - 'stock_hkd': Hong Kong stocks (ends with .HK)
        - 'stock_sgd': Singapore stocks (ends with .SG)
...
def get_cash_key_for_asset(asset: str, asset_type: str) -> str:
    ...
    if asset in LEGACY_CASH_TO_FX:
        return LEGACY_CASH_TO_FX[asset]
    return BASE_CURRENCY
